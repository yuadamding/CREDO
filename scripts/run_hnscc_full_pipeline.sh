...
CREDO_DIR="${CREDO_DIR:-CREDO_publish_tmp}"
...
N_PARTICLES="${N_PARTICLES:-96}"
N_STEPS="${N_STEPS:-24}"
EVAL_PARTICLES="${EVAL_PARTICLES:-384}"
EVAL_STEPS="${EVAL_STEPS:-32}"
EVAL_TARGET_PARTICLES="${EVAL_TARGET_PARTICLES:-768}"
MAX_TRAIN_TARGET_ATOMS="${MAX_TRAIN_TARGET_ATOMS:-768}"
MAX_ACTIVE_PERTURBATIONS="${MAX_ACTIVE_PERTURBATIONS:-16}"
